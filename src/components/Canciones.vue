...
<template>
  <div class="container">
    ...
    <div v-else>
      ...
      <div v-if="data && data.songs" class="containerSong">
        <div v-for="song in data.songs" class="container-items">
          ...
          <RouterLink :to="`/canciones/${song.id}`" class="enlaces subtle">Ver detalle de la cancion</RouterLink>
        </div>
      </div>
    </div>
  </div>
